...
// **********************************************************************
void MontaVetor(int Px, int Py, int Vetor[8])
{
    int leftTopX = Px - 1;
    int leftTopY = Py - 1;
    int topX = Px;
    ...
    int rightX = Px + 1;
    int rightY = Py;
    int rightBottomX = Px + 1;
    int rightBottomY = Py + 1;
    int bottomX = Px;
    int bottomY = Py + 1;
    int leftBottomX = Px - 1;
    int leftBottomY = Py + 1;
    int leftX = Px - 1;
    int leftY = Py;

    Vetor[0] = Image.GetPointIntensity(leftTopX, leftTopY);
    Vetor[1] = Image.GetPointIntensity(topX, topY);
    Vetor[2] = Image.GetPointIntensity(rightTopX, rightTopY);
    Vetor[3] = Image.GetPointIntensity(rightX, rightY);
    Vetor[4] = Image.GetPointIntensity(rightBottomX, rightBottomY);
    Vetor[5] = Image.GetPointIntensity(bottomX, bottomY);
    Vetor[6] = Image.GetPointIntensity(leftBottomX, leftBottomY);
    Vetor[7] = Image.GetPointIntensity(leftX, leftY);
}
// **********************************************************************
// void Mediana()
// **********************************************************************
...
void init()
{
    ...
    r = Image.Load("Imagens//Ruido3.bmp"); // Carrega uma imagem
